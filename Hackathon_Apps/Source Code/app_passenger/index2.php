...
<html>
        ...
        <script>
            var map;
                    ...
                    query.get("BzVL57LOEx", {
                     ...
                     document.getElementById("pas_no").innerHTML = "NO of Passenger-  " + " " + no_pass;
    ...
    <body>
        <div class="section">
            <div class="container">
                <h2 class="text-center text-danger">Passenger Application</h2>
                <div class="row">
                    <div class="col-md-9">
                    ...
                    <div class="col-md-3">
                        ...
                        <h3 id="cus">Driver Name:-</h3>
                        <h3 id="cus_no">Driver Contact No:-</h3>
                        <h3 id="pas_no">No of passenger:-</h3>
                        <h3 id="prt">Max Capacity:- 40</h3>
                        <h3 id="dyn_no">Dynamic Pricing:-</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
